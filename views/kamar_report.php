        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan</h3>
                </div>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/arsip_satu.php?id_kamar=<?= $data['id_kamar'] ?>" target="_blank" class="btn btn-info btn-xs">
